...
/**
 * Simply wrap the code into an IIFE to prevent it overwrite the global postMessage function
 * because the react-cusdis loader does not add "module" attribute,
 * and I did not update that package, just made it works. (so lazy...)
 *
 * https://github.com/Cusdis/sdk/blob/875b4b6/packages/react-cusdis/src/useScript.ts
 */
(() => {
  window.CUSDIS = {}
